...
def display_question(question_id):
    ...
    return render_template('display_and_add_answer.html', question_id=question_id, current_question=current_question, question_data=question_data, answer_data=answer_data)
